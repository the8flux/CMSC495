...
class DBUpdate:
    ...
    A class to create sql statements to update tables.
    ...
    def update_price_adjustment(self, price_adjustment_id, title=None, reason_description=None,
                                is_fixed=None, fixed_amount=None, is_percent=None, percent=None):
        """
        Update PriceAdjustment Record
    ...
    def update_item_category(self, item_category_id, item_category_title=None, item_category_description=None):
        """
    ...
    def update_user_type(self, user_type_id, description=None):
        """
         Update UserType Record
        :param user_type_id:
        :param description:
        :return:
        """
    ...
    def update_catalog_item(self, catalog_item_id, manufacturer_id=None, catalog_item_name=None,
    ...
    def update_inventory_item(self, item_id, catalog_item_id=None, stock_quantity=None, item_serial_number=None,
                              sell_price=None):
        """
    ...
    def update_address(self, address_id, street_address=None, city=None, state=None, country=None, postal_code=None):
        """
